...
import { AlertTriangle, CheckCircle, RefreshCw, PlusCircle } from 'lucide-react';
...
export const DishImportStrategyDialog: React.FC<DishImportStrategyDialogProps> = ({
  duplicateCount,
  newCount,
  onSelect,
  onCancel,
  ...
  const strategies = [
    ...
    },
    {
      ...
      title: '覆盖现有菜品',
      description: `用Excel数据更新 ${duplicateCount} 个已存在的菜品`,
      color: 'blue',
    },
    {
      value: 'create_all' as ImportStrategy,
