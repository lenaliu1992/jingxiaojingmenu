...
export const DataPersistenceControls: React.FC<DataPersistenceControlsProps> = ({
  hasUnsavedChanges,
  onSave,
  onLoad,
}) => {
  return (
    <>
      ...
      >
        ...
        {hasUnsavedChanges && (
          <span className="absolute -top-1 -right-1 w-3 h-3 bg-orange-500 rounded-full border-2 border-white" title="有未保存的更改" />
        )}
      </button>
